...
<?php require "menu.php"; ?>
  <div id="contents">
    <?php if (! empty($result)): 
      $app->form("editdone.php", true, array("item" => $item), array("enctype" => "multipart/form-data"), true);  ?>
      ...
      <tr>
      <td>URL</td><td><input type="text" name="url" value="<?php e($result['url']); ?>" size="30" placeholder="補足URL（任意）"></td>
      </tr>
      <tr>
      <td>URL（タイトル）</td><td><input type="text" name="url_text"  value="<?php e($result['url_text']); ?>" size="30" placeholder="URLの表示文字列（任意）"></td>
      </tr>
      </table><br>
